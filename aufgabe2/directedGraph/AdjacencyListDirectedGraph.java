...
public class AdjacencyListDirectedGraph<V> implements DirectedGraph<V> {
	...
	/**
	 ...
	 Falls einer der beiden Knoten noch nicht im Graphen vorhanden ist, dann wird er dazugefügt.
		Falls die Kante schon vorhanden ist, dann wird das Gewicht mit weight überschrieben.
	 ...
	 *  Falls einer der beiden Knoten noch nicht im Graphen vorhanden ist, dann wird er dazugefügt. 
	 * Falls die Kante schon vorhanden ist, dann wird das Gewicht mit 1 überschrieben.
	Parameter:
	v - Startknoten
	w - Zielknoten
	Gibt zurück:
	...
	*/
	...
	public static void main(String[] args) {
		...
		/**
		 * getSuccessorVertexSet(v) gibt ein unveränderbares Set mit Collections.unmodifiableSet() zurück.
